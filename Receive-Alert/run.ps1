...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #333333;">
    ...
    <![endif]-->
        ...
        -->
        <div style="max-width: 1800px; margin: 0 auto;" class="email-container">
            <!--[if mso]>
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="1800px">
            <tr>
            <td>
            <![endif]-->
...
$HaloTicketCreate = @{
    ...
    New-HaloTicket -Ticket $HaloTicketCreate
